addLayer("ucp", {
    ...
    resource: "M点", // Name of prestige currency
...
addLayer("A", {
    ...
    color: "#00aaaa",
    requires: new Decimal(1145140), // Can be a function that takes requirement increases into account
    resource: "A点", // Name of prestige currency
...
addLayer("WHAT", {
    ...
    symbol: "WHAT", // This appears on the layer's node. Default is the id with the first letter capitalized
    position: 1, // Horizontal position within a row. By default it uses the layer id and sorts in alphabetical order
    startData() { return {
        unlocked: false,
    ...
    color: "#00aaaa",
    requires: new Decimal(191981000), // Can be a function that takes requirement increases into account
    resource: "WHAT", // Name of prestige currency
    baseResource: "points", // Name of resource prestige is based on
    baseAmount() {return player.points}, // Get the current amount of baseResource
    type: "static", // normal: cost to gain currency depends on amount gained. static: cost depends on how much you already have
